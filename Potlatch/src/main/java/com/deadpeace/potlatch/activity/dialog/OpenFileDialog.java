package com.deadpeace.potlatch.activity.dialog;
        ...
        public View getView(int position,View convertView,ViewGroup parent)
        {
            ...
            if(view!=null)
            {
                ...
                else
                {
                    ...
                    view.setBackgroundColor(getContext().getResources().getColor(selectedIndex==position?android.R.color.holo_blue_dark:android.R.color.transparent));
                }
            }
            return view;
        }
